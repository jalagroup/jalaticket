    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: const TextTheme(
          displayLarge:  TextStyle(fontSize: 28, fontWeight: FontWeight.w600, height: 1.3),
          displayMedium: TextStyle(fontSize: 24, fontWeight: FontWeight.w600, height: 1.3),
          displaySmall:  TextStyle(fontSize: 20, fontWeight: FontWeight.w500, height: 1.3),
          headlineLarge: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, height: 1.4),
          headlineMedium:TextStyle(fontSize: 16, fontWeight: FontWeight.w600, height: 1.4),
          headlineSmall: TextStyle(fontSize: 15, fontWeight: FontWeight.w500, height: 1.4),
          titleLarge:    TextStyle(fontSize: 15, fontWeight: FontWeight.w600, height: 1.4),
          titleMedium:   TextStyle(fontSize: 14, fontWeight: FontWeight.w500, height: 1.4),
          titleSmall:    TextStyle(fontSize: 13, fontWeight: FontWeight.w500, height: 1.4),
          bodyLarge:     TextStyle(fontSize: 15, fontWeight: FontWeight.w400, height: 1.5),
          bodyMedium:    TextStyle(fontSize: 13.5, fontWeight: FontWeight.w400, height: 1.5),
          bodySmall:     TextStyle(fontSize: 12, fontWeight: FontWeight.w400, height: 1.5),
          labelLarge:    TextStyle(fontSize: 13, fontWeight: FontWeight.w500, height: 1.3),
